...
public func eq<T>(_ value: T, equalWhen equalityFunction: (T, T) -> Bool) -> ParameterMatcher<T> {
...
public func equalTo<T>(_ value: T, equalWhen equalityFunction: (T, T) -> Bool) -> ParameterMatcher<T> {
